...
advanceChar = (char) ->
	...
	if(char - 49 == typedLetters + typedWrongLetters)
		typedLetters++
		$(id).addClass("correct")
	else if(typedLetters + typedWrongLetters == 9 && char == 48)
		typedLetters++
		$(id).addClass("correct")
	else
		typedWrongLetters++
...
$(document).keypress (e)->
	if(e.which == 13)
		reset()
	else if(typedLetters + typedWrongLetters == 10)
		return
	else if (e.shiftKey)
...
$ ->
	...
	$("#a, #b, #c, #d, #e, #f, #g, #h, #i, #j").click -> chooseStart(this.innerHTML)

# stopwatch
# http://stackoverflow.com/questions/10329900/how-do-i-display-millisecond-in-my-stopwatch
